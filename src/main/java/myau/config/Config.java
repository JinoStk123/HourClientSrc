...
public class Config {
    ...
    public Config(String name, boolean newConfig) {
        ...
        this.file = new File("./config/HourClient/", String.format("%s.json", this.name));
        try {
    ...
    public void load() {
        try {
            ...
            if (!file.exists()) {
                ChatUtil.sendFormatted(String.format("%sConfig file not found (&c&o%s&r). Creating default config...&r", HourClient.clientName, file.getName()));
                save();
                return;
            }
            ...
            if (parsed == null || !parsed.isJsonObject()) {
                ChatUtil.sendFormatted(String.format("%sInvalid config format (&c&o%s&r)&r", HourClient.clientName, file.getName()));
                return;
            }
            ...
            ChatUtil.sendFormatted(String.format("%sConfig has been loaded (&a&o%s&r)&r", HourClient.clientName, file.getName()));
        } catch (FileNotFoundException e) {
            ChatUtil.sendFormatted(String.format("%sConfig file not found (&c&o%s&r)&r", HourClient.clientName, file.getName()));
        } catch (JsonSyntaxException e) {
            ChatUtil.sendFormatted(String.format("%sConfig has invalid JSON syntax (&c&o%s&r)&r", HourClient.clientName, file.getName()));
            ...
            ChatUtil.sendFormatted(String.format("%sConfig couldn't be loaded (&c&o%s&r)&r", HourClient.clientName, file.getName()));
        }
    }
