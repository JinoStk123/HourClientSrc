    ...
    public void onTick(TickEvent event) {
        if (this.isEnabled()) {
            switch (event.getType()) {
                case PRE:
                    HourClient.lagManager.setDelay(0);
                    ...
                    if ((!bedNuker.isEnabled() || !bedNuker.isReady())
                        ...
                        if (players.isEmpty()) {
                            ...
                            Vec3 eyePosition = HourClient.lagManager.getLastPosition().addVector(0.0, height, 0.0);
                            ...
                            for (EntityPlayer player : players) {
                                ...
                                if (!(distance > (double) this.range.getValue())) {
                                    ...
                                    if (distance < targetDist || distance < eyeDist) {
                                        ...
                                        HourClient.lagManager.setDelay(this.tickIndex);
                                        this.hasTarget = true;
                                        return;
                                    }
                                }
                    ...
                    break;
                case POST:
                    Vec3 savedPosition = HourClient.lagManager.getLastPosition();
            ...
            if (this.showPosition.getValue() != 0
                ...
                switch (this.showPosition.getValue()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        color = ((HUD) HourClient.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis());
                }
                ...
                RenderUtil.drawFilledBox(aabb, color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
