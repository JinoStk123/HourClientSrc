        ...
        if (event.getType() == EventType.POST) {
            if (this.reverseFlag
                    ...
                    this.canDelay()
                            ...
                            || myau.HourClient.delayManager.getDelay() >= (long) this.delayTicks.getValue()
            )) {
                myau.HourClient.delayManager.setDelayState(false, DelayModules.VELOCITY);
                ...
                if (packet.getEntityID() == mc.thePlayer.getEntityId()) {
                    ...
                    if (this.mode.getValue() == 2
                        ...
                        if (this.delayChanceCounter >= 100) {
                            myau.HourClient.delayManager.setDelayState(true, DelayModules.VELOCITY);
