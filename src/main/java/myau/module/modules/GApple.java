...
import net.minecraft.client.settings.KeyBinding; // Import KeyBinding
import myau.mixin.IAccessorKeyBinding; // Import IAccessorKeyBinding
import net.minecraft.util.BlockPos; // Keep for completeness if needed elsewhere, though not for eating packet
...
public class GApple extends Module {
    ...
    public void onTick(TickEvent event) {
        ...
        if (!isEating) {
            if (!eatInCombat.getValue() && HourClient.playerStateManager.isInCombat()) {
