...
public class TargetStrafe extends Module {
    ...
    private boolean canStrafe() {
        if (this.speedOnly.getValue()) {
            Speed speed = (Speed) myau.HourClient.moduleManager.modules.get(Speed.class);
            Fly fly = (Fly) myau.HourClient.moduleManager.modules.get(Fly.class);
    ...
    private EntityLivingBase getKillAuraTarget() {
        KillAura killAura = (KillAura) myau.HourClient.moduleManager.modules.get(KillAura.class);
    ...
    private Color getTargetColor(EntityLivingBase entityLivingBase) {
        ...
        switch (this.showTarget.getValue()) {
            ...
            case 2:
                int color = ((HUD) myau.HourClient.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis()).getRGB();
