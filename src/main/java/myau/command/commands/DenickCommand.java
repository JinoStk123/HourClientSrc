...
public class DenickCommand extends Command {
    ...
    public void runCommand(ArrayList<String> args) {
        if (args.size() < 2) {
            ChatUtil.sendFormatted(String.format("%sUsage: .%s <&oname&r>&r", HourClient.clientName, args.get(0).toLowerCase(Locale.ROOT)));
        } else {
                ...
                if (property != null) {
                    ...
                    ChatUtil.sendRaw(
                            String.format(
                                    ...
                                    ChatColors.formatColor(HourClient.clientName),
