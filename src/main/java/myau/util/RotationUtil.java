...
public class RotationUtil {
    ...
    public static float getSmoothedRotation(float current, float target, float factor) {
        float angleDiff = MathHelper.wrapAngleTo180_float(target - current);
        return current + angleDiff * MathHelper.clamp_float(factor, 0.0F, 1.0F);
    }
}