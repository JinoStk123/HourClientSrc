...
public class Account {
    ...
    // New constructor for offline accounts
    public Account(String username, boolean isOffline) {
        this.username = username;
        this.isOffline = isOffline;
        this.accessToken = ""; // Default empty for offline
        this.refreshToken = ""; // Default empty for offline
        this.clientId = ""; // Default empty for offline
        this.scope = ""; // Default empty for offline
        this.unban = 0L; // Default
    }
    ...
    public boolean isOffline() { // New getter
        return isOffline;
    }

    public void setOffline(boolean offline) { // New setter
        isOffline = offline;
    }
